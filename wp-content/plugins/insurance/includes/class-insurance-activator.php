...
//        $activator->setDataTableBlankType();
...
//        $activator->updateUserInsuranceVisibleCompanies();
    ...
    /*
     * Заполнения таблички данными setDataTableBlankType
     *
     */
    public function setDataTableBlankType()
    {
        global $wpdb;
        ...
        $table_name = $wpdb->prefix . "insurance_blank_type";
