...
function covid_list_render( $insurance_list, $program_id = '' ) {
    ...
    if( ! empty( $results ) ) {
        foreach ($results as $k_insured_sum => $v_insured_sum) {
            ...
            foreach ($v_insured_sum as $k_company => $v_company) {
                ...
                $result .= '<div class="col-sm-2 col-md-2 js-change-insurer-sum"><div class="step-3-dcv"><div class="step-3-results-item-title">Оберiть франшизу</div>';
                ...
                $result .= '<div class="col-sm-2 col-md-2"><div class="step-3-dcv"><div class="step-3-results-item-title">Оберiть страхову суму</div>';
                ...
                // $result .= '<div class="col-md-2"><button data-company-id="' . $v_company['company_id'] . '" data-cmpany-name="' . $k_company . '" data-insurance-currency="" data-insurance-period="'. $v_company['validity'] .'" data-insurance-price="' . $company['price'] . '" data-franchise-amount="' . $rate_franchise . '"  data-rate-id="'. $rate_id .'" data-rate-franchise="' . $rate_franchise . '" data-rate-validity="'. $v_company['validity'] .'" data-rate-insured-sum="'. $k_insured_sum .'" data-rate-price="' . $company['price'] . '"  class="btn-get-it js-get-insurance">Придбати</button></div>';
                $result .= '<div class="col-md-2"><button data-program-id="' . $program_id . '" data-company-id="' . $v_company['company_id'] . '" data-cmpany-name="' . $k_company . '" data-insurance-currency="" data-insurance-period="' . $k_insured_sum . '" data-insurance-price="' . $price . '" data-franchise-amount="' . $franchise_amount . '"  data-rate-id="' . $rate_id . '" data-rate-franchise="' . $franchise_amount . '" data-rate-validity="' . $k_insured_sum . '" data-rate-insured-sum="' . $insured_sum . '" data-rate-price="' . $price . '" class="btn-get-it js-get-insurance">Придбати</button></div>';
    ...
    /*foreach( $results as $k_insured_sum => $v_insured_sum ){
        ...
        foreach( $v_insured_sum as $k_company => $v_company ){
            ...
            // $result .= '<div class="col-md-2"><button data-company-id="' . $v_company['company_id'] . '" data-cmpany-name="' . $k_company . '" data-insurance-currency="" data-insurance-period="'. $v_company['validity'] .'" data-insurance-price="' . $company['price'] . '" data-franchise-amount="' . $rate_franchise . '"  data-rate-id="'. $rate_id .'" data-rate-franchise="' . $rate_franchise . '" data-rate-validity="'. $v_company['validity'] .'" data-rate-insured-sum="'. $k_insured_sum .'" data-rate-price="' . $company['price'] . '"  class="btn-get-it js-get-insurance">Придбати</button></div>';
            $result .= '<div class="col-md-2"><button data-program-id="'. $program_id .'" data-company-id="' . $v_company['company_id'] . '" data-cmpany-name="' . $k_company . '" data-insurance-currency="" data-insurance-period="'. $v_company['validity'] .'" data-insurance-price="' . $price . '" data-franchise-amount="' . $rate_franchise . '"  data-rate-id="'. $rate_id .'" data-rate-franchise="' . $rate_franchise . '" data-rate-validity="'. $v_company['validity'] .'" data-rate-insured-sum="'. $k_insured_sum .'" data-rate-price="' . $price . '" class="btn-get-it js-get-insurance">Придбати</button></div>';
