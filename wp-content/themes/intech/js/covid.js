            ...
            jQuery('body').on('click', '.js-select-insurance-age li', function(){
                ...
                if( SetInsuranceList.length != 0 ){
                    ...
                    SetInsuranceList.forEach((item, index, array) => {
                        ...
                        renderInsuranceList += '<div class="col-sm-4 col-md-4"><div class="step-3-dcv"><div class="step-3-results-item-title">Оберiть страхову суму</div>';
                        ...
                        //Render Button
                        renderInsuranceList += '<div class="col-md-2"><button data-company-id="'+ item.id +'" data-cmpany-name="'+ item.name +'" data-insurance-currency="'+ CheckedInsurancecurrency +'" data-insurance-period="'+ insurancePeriod +'" data-insurance-price="'+ CheckedInsurancePrice +'" data-insurance-amount="'+ CheckedInsuranceAmount +'" class="btn-get-it js-get-insurance">Придбати</button></div>';
