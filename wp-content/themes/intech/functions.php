...
//    <input type="hidden" name="date" value=' . date("d.m.Y H:i:s" ) . ' required/>
//    <input type="hidden" name="liqpay_product_id"  value=" . $product_id . "/>
//    <input type="hidden" name="hidden_content"  value="test content"/>
//    <input type="hidden" name="url_page"  value="https://24.epolicy.com.ua/"/>
//    <input type="hidden" name="ip"  value="' . $_SERVER['REMOTE_ADDR'] . '"/>
//    <input type="hidden" name="pay_type"  value="pay"/>
//    <input type="hidden" name="fio" value=" . $user_name . "/>
//    <input type="hidden" name="mail" value=" . $user_email . "/>
...
//                    $result['order_id'] = $wpdb->insert_id;
     ...
     *
     */
//    include_once "./wp-content/plugins/liqpay_wordpress/api.php";
//
//
...
//            'amount' => 1000,
//            'currency' => 'UAH',
//            'description' => 'Оплата за полис страхования',
//            'order_id' => $liq_order_id,
////        'server_url' => $server_url,
//            'server_url' => $result_url,
//            'result_url' => $result_url,
//            'action' => $pay_type,
////        'public_phone'=> $liqpay_phone,
////        'subscribe_periodicity'=> $subscribe_type,
